...
Show HN: parapilot – MCP server that lets AI render CFD/FEA simulations headlessly
...
parapilot solves this by wrapping VTK's rendering pipeline as MCP tools.
...
Docs: https://kimimgo.github.io/parapilot
